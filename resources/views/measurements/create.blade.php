    ...
    <div x-data="{
        ...
        <form action="{{ route('customers.measurements.store', $customer) }}" method="POST">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 border border-gray-200 dark:border-gray-700 mb-6">
                ...
                <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">Click a piece to select it and enter its measurements below.</p>
            </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    @foreach([
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" name="{{ $field }}" id="{{ $field }}" value="{{ old($field) }}" placeholder="0.0"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="measurement_date" id="measurement_date" value="{{ old('measurement_date', date('Y-m-d')) }}" required
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-white text-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="fitting_notes" id="fitting_notes" rows="3" placeholder="Any special notes about fit, posture, or style preferences..."
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-white text-sm focus:ring-blue-500 focus:border-blue-500">{{ old('fitting_notes') }}</textarea>
                    </div>
                </div>
                <div class="mt-6 flex justify-end gap-3">
                    <a href="{{ route('customers.show', $customer) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition text-sm">
                        Cancel
                    </a>
